...
%% PARAMETRY
parametryImportu            = [];
parametryImportu.filename   = 'motion1.avi';    % nazwa pliku wejściowego video

parametryAlg         = [];                  % struktura parametrów algorytmu przetwarzania video
% -------------------------------------------------------
% UZUPEŁNIJ_1 - dobierz parametry algorytmu MHI
parametryAlg.threshold = 20;                % próg detekcji ruchu (motion threshold)
parametryAlg.tau = 5;                       % parametr tau
% -------------------------------------------------------
